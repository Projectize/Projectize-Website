...
const whitegit = <svg width="98" height="96" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <>
            <div className = "h-screen w-screen bg-zinc-900 flex relative">
                ...
                <div className = "z-8 mx-auto my-auto">
                    ...
                    <ButtonGroup className="mx-auto mt-5">
                        <Button><Download/>Download</Button>
                        <Button variant = "secondary">{whitegit}Github</Button>
                    </ButtonGroup>
                </div>
            </div>
        </>
